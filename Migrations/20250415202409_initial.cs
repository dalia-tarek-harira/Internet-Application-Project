    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowPrice = table.Column<int>(type: "int", nullable: false),
                    ...
                    BookOwnerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookPosts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BorrowRequests_BookPosts_BookPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPosts_UserId",
                table: "BookPosts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_BookPostId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(
                name: "AspNetUserRoles");  // Drop this first as it references both Users and Roles
            ...
            migrationBuilder.DropTable(
                name: "AspNetRoles");  // Drop Roles before Users
